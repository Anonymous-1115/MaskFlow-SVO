...
inline void declareEdgeSE3(py::module& m) {
  ...
  templatedBaseUnaryEdge<3, Vector3, VertexSE3>(m, "_3_Vector3_VertexSE3");
  py::class_<EdgeSE3XYZPrior, BaseUnaryEdge<3, Vector3, VertexSE3>,
             std::shared_ptr<EdgeSE3XYZPrior>>(m, "EdgeSE3XYZPrior")
      .def(py::init<>())

      .def("compute_error", &EdgeSE3XYZPrior::computeError)
      .def("set_measurement_from_state", &EdgeSE3XYZPrior::setMeasurementFromState)
      .def("initial_estimate_possible", &EdgeSE3XYZPrior::initialEstimatePossible)
      .def("linearize_oplus", &EdgeSE3XYZPrior::linearizeOplus);
}
