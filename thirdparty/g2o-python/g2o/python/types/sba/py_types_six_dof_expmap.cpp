...
// TODO: newly add
#include "g2o/types/sba/edge_mine.h"
#include "g2o/types/sba/edge_mine_onlypose.h"
#include "g2o/types/sba/edge_trans_norm.h"
...
void declareTypesSixDofExpmap(py::module& m) {
  ...
  py::class_<EdgeMine,
             BaseBinaryEdge<3, Vector3, VertexPointXYZ, VertexSE3Expmap>,
             std::shared_ptr<EdgeMine>>(m, "EdgeMine")
      .def(py::init<>())
      .def("compute_error", &EdgeMine::computeError)
      .def("is_depth_positive", &EdgeMine::isDepthPositive)
      .def("linearize_oplus", &EdgeMine::linearizeOplus);
  ...
  // TODO: EdgeMineOnlyPose
  py::class_<EdgeMineOnlyPose,
             BaseUnaryEdge<3, Vector3, VertexSE3Expmap>,
             std::shared_ptr<EdgeMineOnlyPose>>(m, "EdgeMineOnlyPose")
      .def(py::init<>())
      .def("compute_error", &EdgeMineOnlyPose::computeError)
      .def("is_depth_positive", &EdgeMineOnlyPose::isDepthPositive)
      .def("linearize_oplus", &EdgeMineOnlyPose::linearizeOplus)
      .def_readwrite("Xw", &EdgeMineOnlyPose::Xw)
      .def_readwrite("cov_c", &EdgeMineOnlyPose::cov_c)
      .def_readwrite("cov_w", &EdgeMineOnlyPose::cov_w);

  // TODO: EdgeTransNorm
  templatedBaseBinaryEdge<1, double, VertexSE3Expmap, VertexSE3Expmap>(
      m, "BaseBinaryEdge_1_double_VertexSE3Expmap_VertexSE3Expmap");
  py::class_<EdgeTransNorm,
             BaseBinaryEdge<1, double, VertexSE3Expmap, VertexSE3Expmap>,
             std::shared_ptr<EdgeTransNorm>>(m, "EdgeTransNorm")
      .def(py::init<>())
      .def("compute_error", &EdgeTransNorm::computeError)
      .def("linearize_oplus", &EdgeTransNorm::linearizeOplus)
      .def_readwrite("delta_t", &EdgeTransNorm::delta_t);
